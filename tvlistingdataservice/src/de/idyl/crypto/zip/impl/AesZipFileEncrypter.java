...
public class AesZipFileEncrypter {
	...
	private static final Logger LOG = Logger
			.getLogger(AesZipFileEncrypter.class.getName());
	...
	protected void add(ZipEntry zipEntry, ZipFileEntryInputStream zipData,
		...
		if (LOG.isLoggable(Level.FINE)) {
			LOG.fine("finalAuthentication="
					+ Arrays.toString(finalAuthentication) + " at pos="
					+ zipOS.getWritten());
		}
	...
	public void zipAndEcrypt(File pathToFile, String password)
			throws IOException {
	...
	public void addEncrypted(File pathToZipFile, String password)throws IOException {
		System.out.println("path to zip file : "+pathToZipFile);
